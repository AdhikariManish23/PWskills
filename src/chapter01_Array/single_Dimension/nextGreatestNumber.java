...
//  OPRIMISED (Method)
    ...
    public static void main(String[] args) {
        ...
        ans[n-1] = -1;  // fill the last elemnt of answer array with -1; (because there is no number left to check the greatest when we are on the i = 0 )
        ...
        for(int i = n-2; i >= 0; i-- ){
            ...
            nge = Math.max(nge, arr[i]);  // phir nge ko update kra compare kr (nge,arr[i]) => (21,28) ;; arr[i] == to 28 i is starting with n-2.
        }
